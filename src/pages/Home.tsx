...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="sticky top-0 z-50 bg-white border-b border-border shadow-sm">
        <div className="container flex items-center justify-between h-20">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-xl tracking-tight text-[#1A1A1A]">VARGAS DIGITAL</span>
          </div>
          
          {/* MENÚ DE NAVEGACIÓN CON ESPACIADO CORREGIDO */}
          <div className="hidden md:flex items-center gap-10">
            <a href="#servicios" className="text-sm font-semibold text-[#666666] hover:text-[#0052CC] transition-colors">
              Servicios
            </a>
            <a href="#quienes-somos" className="text-sm font-semibold text-[#666666] hover:text-[#0052CC] transition-colors">
              Quiénes Somos
            </a>
            <a href="#testimonios" className="text-sm font-semibold text-[#666666] hover:text-[#0052CC] transition-colors">
              Testimonios
            </a>
            <a href="#contacto" className="text-sm font-semibold text-[#666666] hover:text-[#0052CC] transition-colors">
              Contacto
            </a>
          </div>
          ...
          <a
            ...
            className="hidden lg:block bg-[#0052CC] hover:bg-blue-700 text-white px-6 py-2.5 rounded-lg font-bold transition-all shadow-md"
          >
        ...
        <div className="container relative z-10">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 mb-8 bg-blue-50 border border-blue-100 px-4 py-2 rounded-full">
              ...
              <span className="text-sm font-bold text-[#0052CC]">🚀 Impulsamos tu Negocio en Internet</span>
            </div>
            <h1 className="text-5xl md:text-7xl font-extrabold text-[#1A1A1A] mb-8 leading-tight tracking-tighter">
              Diseño Web Profesional para Empresas y Emprendedores
            </h1>
            <p className="text-xl md:text-2xl text-[#666666] mb-10 leading-relaxed max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center bg-[#0052CC] hover:bg-blue-700 text-white text-lg font-bold px-8 py-4 rounded-xl transition-all shadow-xl"
              >
                ¡QUIERO MI PÁGINA WEB!
              </a>
              <Button size="lg" variant="outline" className="border-2 border-[#0052CC] text-[#0052CC] hover:bg-blue-50 px-8 py-4 text-lg font-bold rounded-xl">
                Conocer Más
              </Button>
            </div>
          </div>
      ...
      <section className="py-24 md:py-32 bg-slate-50">
        <div className="container">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold text-[#1A1A1A] mb-6">Nuestro Equipo</h2>
          ...
          <div className="flex justify-center">
            <div className="flex flex-col items-center text-center max-w-sm">
              {/* RUTA DE IMAGEN CORREGIDA A LA RAÍZ DE PUBLIC */}
              <div className="w-40 h-40 rounded-2xl overflow-hidden mb-8 shadow-2xl border-4 border-white">
                <img
                  src="/images/marcelo-vargas-final-v1.png"
                  alt="Fundador - VARGAS DIGITAL"
                  className="w-full h-full object-cover"
                  onError={(e) => {
                    // Respaldo por si la ruta local falla en Vercel
                    e.currentTarget.src = "https://vargasweb-9dmmkf68.manus.space/manus-storage/team-member-profile_773d761c.png";
                  }}
                />
              </div>
              <h3 className="text-3xl font-bold text-[#1A1A1A] mb-2">Marcelo Vargas</h3>
              <p className="text-[#0052CC] font-bold text-lg mb-4">Fundador & Desarrollador Web</p>
      ...
      {/* Resto de secciones (se mantienen iguales para asegurar paridad) */}
      {/* CTA WhatsApp Section */}
      <section className="py-16 bg-white border-y border-slate-100">
        <div className="container flex flex-col md:flex-row items-center justify-between gap-10">
          <div className="text-center md:text-left">
            <h3 className="text-3xl font-bold text-[#1A1A1A] mb-3">📲 Solicita tu presupuesto</h3>
            <p className="text-lg text-[#666666]">Contacta con nosotros sin compromiso y obtén una propuesta personalizada</p>
          </div>
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="text-center md:text-right">
              <p className="text-sm font-bold text-slate-400 uppercase tracking-widest mb-1">WhatsApp:</p>
              <p className="text-3xl font-black text-[#0052CC]">11 5934-7710</p>
            </div>
            <a
              href={getWhatsAppUrl(PRESUPUESTO_MESSAGE)}
              target="_blank"
              rel="noopener noreferrer"
              className="bg-[#00D084] hover:bg-green-600 text-white text-lg font-bold px-10 py-5 rounded-2xl transition-all shadow-lg flex items-center gap-2"
            >
      ...
      <section id="quienes-somos" className="py-24 md:py-32 bg-white">
        <div className="container">
          <div className="max-w-4xl mb-20">
            <h2 className="text-4xl md:text-6xl font-bold text-[#1A1A1A] mb-8">¿Quiénes Somos?</h2>
            ...
            {[
              ...
              <Card key={idx} className="p-8 border-none bg-slate-50 hover:bg-white hover:shadow-2xl transition-all duration-500 rounded-3xl">
                <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center shadow-sm mb-6">
                  <item.icon className="w-8 h-8 text-[#0052CC]" />
                </div>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {[
              ...
              <div key={idx} className="p-10 rounded-3xl bg-slate-800/50 border border-slate-700 hover:border-[#0052CC] transition-all group">
                <h3 className="text-3xl font-bold mb-4 group-hover:text-[#0052CC] transition-colors">{service.title}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              ...
              <Card key={idx} className="p-10 border-none bg-slate-50 rounded-3xl relative">
                ...
                <p className="font-bold text-[#0052CC] text-lg">— {testimonial.author}</p>
              </Card>
            ))}
          </div>
        </div>
